...
def test_idempotent_featureview_conversion():
    ...
    assert feature_view_model.last_updated_timestamp == feature_view.last_updated_timestamp
    assert feature_view_b.created_timestamp == feature_view_model.created_timestamp
    assert feature_view_b.last_updated_timestamp == feature_view_model.last_updated_timestamp
...
def test_idempotent_on_demand_feature_view_conversion():
    ...
    assert converted_python_obj.last_updated_timestamp == pydantic_obj.last_updated_timestamp
